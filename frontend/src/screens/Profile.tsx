...
import { validationSchema, validationSchemaPassword } from "./hooks/Profile/schema";
import { useMutation } from "@tanstack/react-query";
import { updateUserData, UpdateUserDataRequestBody } from "./hooks/Profile/api";
import useSnackbar from "@src/hooks/useSnackbar";
import LoadingButton from "@mui/lab/LoadingButton";
import { updatePassword, UpdatePasswordRequestBody } from "@src/api/updatePassword";
...
const Profile = () => {
  ...
  const { mutate: updateUserDataMutate, isPending } = useMutation({
    ...
    onError: (error) => {
      const errorMessage = error.response?.data?.message.includs("Phone number")
      errorMessage
        showSnackbar({ severity: "warning", message: errorMessage })

        showSnackbar({ severity: "success", message: "User's data updated successfuly" });
console.log(error)
  ...
  const { mutate: updateFormPassword, isPending: isUpdatePasswordPending } = useMutation({
